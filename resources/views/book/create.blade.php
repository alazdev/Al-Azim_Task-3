    ...
    <div>
        ...
        <form method="POST" action="{{route('book.store')}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="titleBook" value="{{ old('title') }}" required>
                @error('cover')
                    <div id="coverBook" class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('publish_year') is-invalid @enderror" name="publish_year" id="publishYearBook" value="{{ old('publish_year') }}" required>
                @error('publish_year')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('publisher') is-invalid @enderror" name="publisher" id="publisherBook" value="{{ old('publisher') }}" required>
                @error('publisher')
